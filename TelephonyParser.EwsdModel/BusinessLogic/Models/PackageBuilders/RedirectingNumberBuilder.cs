...
public class RedirectingNumberBuilder : IPackageBuilder
{
    public byte PackageNumber => RedirectingNumber.Startbyte;
    ...
    public IRecordPackage BuildPackage(byte[] recordBytes, int packageNumberPosition)
    {
        ...
        return new RedirectingNumber(packageLength, nadi, npi, presInd, screening, lacLength, numberOfDigits, packedDigits);
    }
